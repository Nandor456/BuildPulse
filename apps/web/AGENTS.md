...
- Unauthenticated `/` shows the public landing page; `/register` is invite-only unless explicitly opened in bootstrap mode with `/register?bootstrap=1`
...
- Public landing CTA reads `VITE_REQUEST_ACCESS_URL`
